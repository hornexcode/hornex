...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='summoner',
            name='league_entry',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='leagueoflegends.leagueentry'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_league_entries', models.ManyToManyField(to='leagueoflegends.leagueentry')),
                ('provider', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='leagueoflegends.provider')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.AddField(
            model_name='code',
            name='tournament',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='leagueoflegends.tournament'),
        ),
    ]

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='registrationparticipants',
            name='registration',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tournaments.registration'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_ellos', models.ManyToManyField(to='tournaments.leagueoflegendsello')),

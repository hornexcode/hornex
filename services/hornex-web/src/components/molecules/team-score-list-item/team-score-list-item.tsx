import CurrencySwapIcons, {
  CoinList,
} from '@/components/ui/currency-swap-icons';
...
export default function FarmList({
  ...
  return (
    <div className="shadow-card hover:shadow-large dark:bg-light-dark relative mb-3 overflow-hidden rounded-lg bg-white transition-all last:mb-0">
      <div
        ...
        {isExpand && (
          ...
          >
            <div className="border-t border-dashed border-gray-200 px-4 py-4 dark:border-gray-700 sm:px-8 sm:py-6">
              <div className="sm:h-13 mb-6 flex items-center justify-center rounded-lg bg-gray-100 p-3 text-center text-xs font-medium uppercase tracking-wider text-gray-900 dark:bg-gray-900 dark:text-white sm:text-sm">

...
export default function ProfileMenuItem({ user }: { user: LoggedUser }) {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <Menu.Button className="group-item text-muted flex w-full items-center justify-center rounded-md bg-opacity-20 px-4 py-2 font-semibold hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
          {/* <Avatar>

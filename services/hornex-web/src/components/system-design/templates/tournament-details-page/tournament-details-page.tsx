import TournamentPhasesWidget from '@/components/system-design/molecules/tournament-phases-widget';
import TournamentDetailsHeadline from '@/components/system-design/organisms/tournament-details-headline';
import TournamentOverviewTabPanel from '@/components/system-design/organisms/tournament-overview-tab-panel/tournament-overview-tab-panel';
import TournamentScoringTabPanel from '@/components/system-design/organisms/tournament-scoring-tab-panel';
import TournamentStandingTabPanel from '@/components/system-design/organisms/tournament-standing-tab-panel';

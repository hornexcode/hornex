export const TwitchStruded: React.FC<React.SVGAttributes<{}>> = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1140 380" {...props}>
      ...
      <g id="Layer_2" data-name="Layer 2">
        <g id="Layer_1-2" data-name="Layer 1">
          ...
          />
          <rect className="fill-white" x="490" y="90" width="80" height="180" />
          <rect className="fill-white" x="490" y="20" width="80" height="50" />
          <polygon
            className="fill-white"

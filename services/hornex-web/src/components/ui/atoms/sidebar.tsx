...
export const Sidebar = ({ className }: { className?: string }) => {
  ...
  return (
    ...
    >
      <ul className="block space-y-3 py-2">
        ...
        <li>
          <Link
            ...
            className="group flex h-[45px] cursor-pointer items-center justify-center rounded bg-gray-700 text-center shadow-lg transition-all hover:bg-slate-700"
          >
      ...
      <div className="h-[1.5px] w-[36px] self-center rounded-md bg-gray-700"></div>
      <ul className="block space-y-3 py-2">
        <li>
          <Link
            href={`/${routes.platform}/league-of-legends/${routes.tournaments}`}
        ...
        <li>
          ...
          >
            <PlusIcon className="fill-dark w-4 rounded-sm bg-gray-700 group-hover:bg-slate-700" />
          </Link>
        </li>
      </ul>
    </div>

    ...
    <main className="px-auto container mx-auto mb-[100px] space-y-10 pt-6">
      ...
      <div className="block rounded-lg border border-gray-800 bg-gray-950 p-6">
        ...
        <form action="" className="space-y-4 md:space-y-6">
          <div>
            {/* Game */}
            <div className="xs:p-6 xs:pb-8 mb-6 rounded-lg border border-gray-700 bg-gray-800 p-5 shadow-card transition-shadow duration-200 hover:shadow-large">
              ...
              <div className="relative">
                <Listbox value={game} onChange={setGame}>
                  ...
                  <Transition
                    ...
                    leaveTo="opacity-0"
                  >
                    <Listbox.Options className="xs:p-2 absolute left-0 z-10 mt-1 grid w-full origin-top-right gap-0.5 rounded-lg border border-gray-200 bg-white p-1 shadow-large outline-none dark:border-gray-700 dark:bg-gray-800">

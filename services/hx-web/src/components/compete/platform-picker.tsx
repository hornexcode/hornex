...
export const PlatformPicker = () => {
  return (
    <Menu as="div" className="relative h-full">
      <Menu.Button className="group flex h-full min-w-[8rem] items-center justify-center gap-3 rounded-lg bg-slate-800 p-2 text-sm text-white shadow-card hover:cursor-pointer">
          ...
          <div className="p-2">
            <Menu.Item>
              {({ active }) => (
                <button
                  ...
                  } flex w-full items-center justify-between gap-3 rounded-lg bg-slate-800 p-2 text-sm text-white`}
                >
                  <div className="flex items-center justify-between gap-2">
                    <ComputerDesktopIcon className="w-6 rounded-md bg-sky-400 p-1" />
            ...
            <Menu.Item>
              {({ active }) => (
                ...
                >
                  <div className="flex items-center justify-between gap-2">
                    <XboxIcon className="w-6 rounded-md bg-green-500 fill-white p-1" />
                    <span>Xbox</span>
                  </div>
                  <ChevronRightIcon className="w-5" />
                </button>

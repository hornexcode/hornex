  ...
  return (
    <div className="rounded bg-light-dark shadow-card">
      ...
      <div className="flex items-start p-4">
        <div className="block">
          <span className="text-xs">Dez 02 @ 20:00 PM (-3)</span>
          <h4 className="text-sm font-semibold leading-5 text-white">
            LOL: The Summer is comming 2023
          </h4>
      ...
      <div className="border-t border-t-slate-800 px-4">
      ...
      <div className="border-t border-t-slate-800 px-4 py-4">
        <div className="grid grid-cols-2 space-y-2 ">
          <div className="col-span-2">
            <div className="flex justify-between">
              <div className="flex items-center">
                <UsersIcon className="mr-1 h-5 w-4 fill-slate-400" />
          ...
          <div className="col-span-2">
            <div className="h-1.5 w-full rounded-full bg-gray-200 dark:bg-gray-700">
              <div
                className={classnames('h-1.5 rounded-full bg-white', 'w-[70%]')}
              ></div>
            </div>
          </div>
        </div>
      ...
      <div className="flex items-center rounded-b-lg border-t border-slate-700 bg-slate-800 px-4 py-4">
        <div className="block">
          {/* <span className="text-xs text-slate-400">Prize Pool</span> */}
          <div className="flex items-center space-x-1">
            <DollarSign className="h-4 w-4 text-white" />
            <span className="text-lg font-semibold text-white">2 320,00</span>
          </div>
        </div>

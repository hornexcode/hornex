    ...
    <div className={cn('relative', className)}>
      <HeadlessListbox value={selectedOption} onChange={onChange}>
        ...
        <Transition
          ...
          leaveTo="opacity-0"
        >
          <HeadlessListbox.Options className="xs:p-2 shadow-large absolute left-0 z-10 mt-1 grid w-full origin-top-right gap-0.5 rounded-lg border border-gray-200 bg-white p-1 outline-none dark:border-gray-700 dark:bg-gray-800">
            {options.map((option) => (
